function [U_vp_cheb,U_1_cheb] = chebInt(params,mflds,y)
...
U_vp_cheb = (Q*pulsePrime_natural_cheb)';


for i = 1:4
    U_vp_ICvec(i) = [chebSum(U_vp_cheb(:,i),-1)];
end
