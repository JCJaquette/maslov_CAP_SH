...
elseif n == 3
    ...
    params.f_error = E_phi*(norm(h1coeffs,1) + norm(h4coeffs,1)) ...
                    + E_h*(norm(phiP1coeffs,1) + norm(phiP2coeffs,1)) ...
                    + 2*E_phi*E_h;

    params.df_error = E_phi*(norm(h1coeffs,1) + norm(h2coeffs,1)) ...
                    + E_h*(norm(phiP1coeffs,1) + norm(phiP3coeffs,1)) ...
                    + 2*E_phi*E_h;
